<?
$MESS ['JQUERY_INC_TIP'] = "Если на вашем сайте уже подключена библиотека jQuery, снимите этот флажок.";
...
$MESS ['FOTORAMA_ID_TIP'] = "Если на странице будет несколько фоторам, задайте для них разные id.";
$MESS ['CONTAINER_WIDTH_TIP'] = "Если ширина и высота не заданы, то размер устанавливается по первой загруженной фотографии.";
$MESS ['CONTAINER_HEIGHT_TIP'] = "Если ширина и высота не заданы, то размер устанавливается по первой загруженной фотографии.";
$MESS ['TRANSITION_DURATION_TIP'] = "Время смены фотографий в миллисекундах. По умолчанию равно 333.";
$MESS ['TOUCH_STYLE_TIP'] = "Если включить эту опцию, то фотографии можно будет листать пальцем на сенсорных устройствах или мышкой в браузере.";
$MESS ['BACKGROUND_COLOR_TIP'] = "Например, #cecece или green.";
$MESS ['MARGIN_TIP'] = "По умолчанию равен 0.";
$MESS ['MIN_PADDING_TIP'] = "Если фотография меньше блока Фоторамы, то она будет увеличена с учетом отступа.";
$MESS ['PRELOAD_TIP'] = "По умолчанию 3.";
$MESS ['ZOOM_TO_FIT_TIP'] = "Растягивать фотографии, размер которых меньше размера блока Фоторамы.";
$MESS ['ARROWS_COLOR_TIP'] = "Например, #cecece или green.";
$MESS ['THUMBS_BACKGROUND_COLOR_TIP'] = "Цвет фона блока с превью или точками-индикаторами, например, #cecece или green.";
$MESS ['THUMB_COLOR_TIP'] = "Например, #cecece или green.";
$MESS ['THUMB_SIZE_TIP'] = "Укажите высоту, а ширина превью будет определена автоматически.";
$MESS ['THUMB_MARGIN_TIP'] = "Отступ вокруг превью (пикс.).";
$MESS ['THUMB_BORDER_COLOR_TIP'] = "Например, #cecece или green.";
$MESS ['CAPTION_TIP'] = "Показывать подписи к фотографиям.";
?>