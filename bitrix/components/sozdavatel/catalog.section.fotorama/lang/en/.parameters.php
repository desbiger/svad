<?
$MESS["JQUERY_INC"] = "Подключать jQuery";
$MESS["T_IBLOCK_DESC_FOTORAMA_ID"] = "ID фоторамы";
$MESS["T_IBLOCK_DESC_CONTAINER_WIDTH"] = "Ширина блока с фотографиями (пикс.)";
$MESS["T_IBLOCK_DESC_CONTAINER_HEIGHT"] = "Высота блока с фотографиями (пикс.)";
$MESS["T_IBLOCK_DESC_TRANSITION_DURATION"] = "Длительность анимации (мс)";
$MESS["T_IBLOCK_DESC_TOUCH_STYLE"] = "Возможность перетаскивать фотографии мышкой на компьютере или пальцем на мобильных устройствах";
$MESS["T_IBLOCK_DESC_BACKGROUND_COLOR"] = "Цвет фона под фотографиями";
$MESS["T_IBLOCK_DESC_MARGIN"] = "Размер горизонтальных отступов между фотографиями (пикс.)";
$MESS["T_IBLOCK_DESC_MIN_PADDING"] = "Минимальный отступ вокруг фотографии (пикс.)";
$MESS["T_IBLOCK_DESC_PRELOAD"] = "Количество предзагружаемых фотографий справа и слева от текущей фотографии";
$MESS["T_IBLOCK_DESC_ZOOM_TO_FIT"] = "Растягивать фотографии";
$MESS["T_IBLOCK_DESC_ARROWS"] = "Показывать стрелки \"следующая/предыдущая фотография\"";
$MESS["T_IBLOCK_DESC_ARROWS_COLOR"] = "Цвет стрелок";
$MESS["T_IBLOCK_DESC_THUMBS_BACKGROUND_COLOR"] = "Цвет фона нижней части";
$MESS["T_IBLOCK_DESC_THUMB_COLOR"] = "Цвет точек-индикаторов";
$MESS["T_IBLOCK_DESC_THUMBS_SIZE"] = "Высота превью (пикс.)";
$MESS["T_IBLOCK_DESC_THUMBS_MARGIN"] = "Отступ вокруг превью (пикс.)";
$MESS["T_IBLOCK_DESC_THUMB_BORDER_WIDTH"] = "Толщина рамки вокруг текущей превью (пикс.)";
$MESS["T_IBLOCK_DESC_THUMB_BORDER_COLOR"] = "Цвет рамки вокруг текущей превью";
$MESS["T_IBLOCK_DESC_CAPTION"] = "Показывать подписи к фотографиям";
$MESS["T_IBLOCK_DESC_THUMBS_STYLE"] = "В нижней части показывать";
$MESS["IBLOCK_THUMBS_PREVIEW"] = "Превью фотографий";
$MESS["IBLOCK_THUMBS_DOTS"] = "Точки-индикаторы для перелистывания фотографий";
$MESS["IBLOCK_THUMBS_NONE"] = "Ничего";
