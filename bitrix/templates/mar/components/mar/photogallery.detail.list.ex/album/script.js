...
window.BXPhotoSlider.prototype = {
	...
	DisplayItem: function(id, bAffectTopSlider)
	{
		...
		{
			if (oItem.video_src) {
				this.pImage = this.pImgCell.appendChild(BX.create('DIV', {
					'props':{ className:'photo-video-loading', id:'bx-ph-' + oItem.id },
					'children':[
						oItem.video_src
					]
				})
	...
	*/
	DisplayRating: function(oItem)
	{
		...
		else
		{
			...
			function(result){setTimeout(function()
			{
				var href = document.location.origin + oItem.detail_url;
				var chared = document.getElementById('share_button');

				$('#twitter-wjs, #mail-wjs, #google-wjs').remove();
				chared.innerHTML = '\n\
					<div id="vk_share_button" style="float: left;width: 140px"><div id="vk_like_photo"></div></div>\
					<div id="vk_share_button" style="float: left;width: 160px"><div id="fb-root"></div><div class="fb_sharer"></div></div>\
					<div style="float: left;width: 90px"><a target="_blank" class="mrc__plugin_uber_like_button" href="http://connect.mail.ru/share" data-mrc-config="{\'nt\' : \'1\', \'cm\' : \'1\', \'ck\' : \'1\', \'sz\' : \'20\', \'st\' : \'2\', \'tp\' : \'ok\'}">Нравится</a></div>\
					<div style="float: left;width: 90px"><div class="g-plusone" data-size="medium" data-href="' + href + '"></div></div>\
					<div style="float: left;width: 90px"><a href="https://twitter.com/share" class="twitter-share-button" data-lang="ru" data-related="newlywedsclubb">Твитнуть</a></div>\
					<div class="end"></div>';
				document.getElementById('vk_like_photo').innerHTML = VK.Share.button({url: href},{type: "button", text: "Сохранить"});
				fb_sharer_init();
				!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//apis.google.com/js/plusone.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","google-wjs");
				!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");
				!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.charset="UTF-8";js.src="//cdn.connect.mail.ru/js/loader.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","mail-wjs");
	...
	CreateSceleton: function()
	{
		...
		this.pPopupFooter.appendChild(BX.create("DIV", {props: {id: "share_button"}}));
	...
	AttachThumbnailsEvents: function()
	{
		var
			_this = this,
			res = this.pElementsCont.getElementsByTagName('div'),
			ii, l = res.length;
...
window.BXPhotoList = function(Params)
{
	...
	this.thumbHeight = this.thumbWidth = this.thumbSize + 40; // thumb size + margin to setermine correct position and size
	...
	console.log(this.initDragSorting);
...
window.BXPhotoList.prototype = {
	...
	InitSort: function()
	{
		var
			_this = this,
			ii, id, ind = 0,
			res = this.pElementsCont.getElementsByClassName('pic_album');
