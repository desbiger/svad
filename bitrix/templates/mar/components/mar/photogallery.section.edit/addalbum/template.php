...
<form method="post" action="<?= POST_FORM_ACTION_URI?>" name="form_photo" id="form_photo" class="photo-form">
	...
	<tr class="photo-album-edit-heading"><td colSpan="2"><?= ($arParams['AFTER_UPLOAD_MODE'] == "Y" ?  GetMessage("P_ALBUM_LOADED_PHOTOS") : GetMessage("P_ALBUM_PHOTOS"))?><span id="bxph_n_from_m<?= $arResult["JSID"]?>"></span>
		<a class="link" href="<?=$arParams['UPLOAD_IMAGE']?>"><?=GetMessage('P_UPLOAD_IMAGE')?></a>
		<a class="link" href="<?=$arParams['UPLOAD_VIDEO']?>"><?=GetMessage('P_UPLOAD_VIDEO')?></a>
	</td></tr>
	...
	<?else:?>
		<tr class="photo-album-edit-heading"><td colSpan="2">
			<a class="link" href="<?=$arParams['UPLOAD_IMAGE']?>"><?=GetMessage('P_UPLOAD_IMAGE')?></a>
			<a class="link" href="<?=$arParams['UPLOAD_VIDEO']?>"><?=GetMessage('P_UPLOAD_VIDEO')?></a>
		</td></tr>
